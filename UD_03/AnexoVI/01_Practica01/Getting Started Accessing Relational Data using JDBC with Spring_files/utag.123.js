...
//Marketo Cookie Association for Anonymous leads...
...
function passCookieInMarketoPayload() {
    var marketoCookie = getCookieRE("_mkto_trk");
    var timeInt;
	//var cookieVal= encodeURIComponent(marketoCookie);
